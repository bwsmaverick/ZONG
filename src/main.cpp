...
#if defined(NDEBUG)
# error "Zong cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Zong Signed Message:\n";
            ...
            return DoS(100, error("ConnectBlock() : coinstake pays too much(actual=%d vs calculated=%d)", nStakeReward, nCalculatedStakeReward));
                ...
                if (pindex->nHeight > 25) {
                    ...
                    BOOST_FOREACH(const CTxOut& output, vtx[1].vout) {  
                       ...
                       CTxDestination addrzong2;
                       ExtractDestination(output.scriptPubKey, addrzong2);
                       std::string GetTxAdressFromTransaction = CBitcoinAddress (addrzong2).ToString().c_str();
                        ...
                        if (GetTxAdressFromTransaction == "CUNL15U3ukREz3ZcF4smtcJ9zvZtGjFefA") {
                            ...
                            if (nOutputZong == (nCalculatedStakeReward / 5)) {
...
#ifdef ENABLE_WALLET
// Zong: attempt to generate suitable proof-of-stake
