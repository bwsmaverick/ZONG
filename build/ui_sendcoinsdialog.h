...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ZONG"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ZONG"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ZONG"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ZONG"));
        ...
        labelBalance->setText(QStringLiteral("123.456 ZONG"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0.00 ZONG", 0));
