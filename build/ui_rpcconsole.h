...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Zong - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Zong Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Zong debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Zong-Qt help message to get a list with possible Zong command-line options.", 0));
#endif // QT_NO_TOOLTIP
